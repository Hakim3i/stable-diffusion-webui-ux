...
3. Download the stable-diffusion-webui repository `git clone https://github.com/anapnoe/stable-diffusion-webui-ux`.
...
```
2. To install in `/home/$(whoami)/stable-diffusion-webui-ux/`, run:
```bash
